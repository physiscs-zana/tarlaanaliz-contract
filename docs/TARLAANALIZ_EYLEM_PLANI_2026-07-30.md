...
| **7** 🔜 | **C8 TÖRENİ** — `pin_version` → annotated tag → 3 depo pin | `SDLC_GATES §3G`. **ÖN KOŞUL ARTIK SAĞLANDI: 1-6 kapandı.** Ayrıca I-2 artık tarihsel olarak da tutuyor (SD8: 18 annotated tag, `git describe` temiz) ve C6'nın MINOR bump'ı iptal olduğu için sürüm hedefi sadeleşti | bu depo + 3 depo |
