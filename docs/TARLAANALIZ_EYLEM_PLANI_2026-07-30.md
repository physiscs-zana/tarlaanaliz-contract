...
| 🔵 **D18-b** | **KOORDİNATÖR KARARI (küçük):** `api-support@tarlaanaliz.com` adresi OpenAPI künyesinde kalsın mı? Şimdilik **dar, beyanlı istisna** (`$.info.contact.email`, yalnız o dosya; künye dışı istisna testle yasak). Adres silinirse istisna da kalkar | 🔵 | — |
