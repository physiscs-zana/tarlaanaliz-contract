...
| **E16-b** 🟠 | edge | **E16'nın ölçülen ikinci dosyası:** küçük harf crop sözlüğü yalnız `worker_result` değil `intake_manifest.sorties[].crop_type` vendored kopyasında da var. E16 ikisini **birlikte** kapatmalı — biri düzeltilirse edge içinde iki ayrı sözlük kalır | ÖD-8 · AK-7 |
